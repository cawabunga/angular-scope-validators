(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["angular-scope-validators"] = factory(require("angular"));
	else
		root["angular-scope-validators"] = factory(root["angular"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = 'scope-validators';
	...
	function createPrimitiveTypeChecker(expectedType) {
	  function validate(props, propName, componentName) {
	    ...
	    if (propType !== expectedType) {
	      ...
	      return new Error('Invalid property `' + propName + '` of type ' + ('`' + preciseType + '` supplied to `' + componentName + '`, expected ') + ('`' + expectedType + '`.'));
	    }
	    return null;
	  }
